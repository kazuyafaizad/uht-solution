...
<head>
    <!--================= Meta tag =================-->
    <meta charset="utf-8">
    <title>Ultrasound Sonoace R7 Courses</title>
...
<body class="courses-grid-page">
        ...
        <div class="react-wrapper-inner">
            ...
            <div class="react-course-filter back__course__page_grid pb---40 pt---110">
                <div class="container pb---70">
                    <h1 class="h1">Ultrasound Sonoace R7 Simulation</h1>
                    <div class="row">
                            ...
                            <div class="inner-course">
                                ...
                                <div class="case-content">
                                    <h4 class="case-title"> <a href="how-to-scan-liver-gallblader-and-aorta">How
                                            To
                                            Scan Liver, GallBlader and Aorta</a></h4>
                                    <ul class="meta-course">
                                        <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <footer class="footer items-center p-4 bg-primary text-primary-content">
